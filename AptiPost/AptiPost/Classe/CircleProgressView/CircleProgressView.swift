...
@objc @IBDesignable public class CircleProgressView: UIView {
    ...
    @IBInspectable public var trackWidth: CGFloat = 7 {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable public var trackFillColor: UIColor = UIColor(red: 255.0/255.0, green: 98.0/255.0, blue: 31.0/255.0, alpha: 1) {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable public var centerFillColor: UIColor = UIColor.clearColor() {
        didSet { setNeedsDisplay() }
    }
